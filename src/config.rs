...
pub use model::{
    ...
    DEFAULT_MAX_PENDING_AUTHENTICATIONS, DEFAULT_OUTBOUND_CONNECT_TIMEOUT,
    DEFAULT_OUTBOUND_CONNECT_TIMEOUT_MS, DEFAULT_PATH_PROBE_INTERVAL,
    DEFAULT_PATH_PROBE_INTERVAL_MS, DEFAULT_PATH_PROBE_TIMEOUT, DEFAULT_PATH_PROBE_TIMEOUT_MS,

...
fn auth_contexts_and_tcp_prelude_have_stable_tags() {
    ...
    assert_eq!(
        ...
        AuthTag([
            0x8e, 0x49, 0x8d, 0x59, 0xba, 0x0b, 0x87, 0x57, 0x11, 0x5d, 0xa3, 0x09, 0x8f, 0x10,
            0x71, 0x17, 0xcd, 0x85, 0x9e, 0xf7, 0xfe, 0xd3, 0x66, 0xb9, 0xa3, 0x76, 0x1f, 0x89,
            0x89, 0x8e, 0x75, 0x29,
        ])
    );
    assert_eq!(
        ...
        AuthTag([
            0xef, 0x7d, 0x48, 0xa0, 0x66, 0xa8, 0x25, 0x91, 0x81, 0x0a, 0xa9, 0xfa, 0x5b, 0xda,
            0x87, 0x14, 0x64, 0x96, 0xa1, 0xfb, 0x93, 0x8c, 0x3f, 0xe1, 0x0b, 0xb8, 0x6e, 0xfa,
            0x90, 0xd7, 0x0e, 0x90,
        ])
    );
    assert_eq!(

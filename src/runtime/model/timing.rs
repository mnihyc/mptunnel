...
pub(in crate::runtime) fn transport_pto_from_ms(srtt_ms: f64, rttvar_ms: f64) -> Duration {
...
pub(in crate::runtime) fn quic_bulk_proof_freshness_horizon(
    srtt: Duration,
    rttvar: Duration,
) -> Duration {
...
pub(in crate::runtime) fn transport_pto_from_snapshot(path: Option<PathSnapshot>) -> Duration {
    path.map(|path| {
...
pub(in crate::runtime) fn path_open_pto(
...
pub(in crate::runtime) fn active_path_open_timeout(
    path: Option<PathSnapshot>,
    rtt_is_observed: bool,
) -> Duration {
...
pub(in crate::runtime) fn active_path_open_pto_multiplier(path: Option<PathSnapshot>) -> u32 {
    active_path_open_serialized_exchanges(path)
        .saturating_sub(1)
        .saturating_add(persistent_congestion_pto_backoff_multiplier())
}

pub(in crate::runtime) fn persistent_congestion_pto_backoff_multiplier() -> u32 {
...
pub(in crate::runtime) fn active_path_open_serialized_exchanges(path: Option<PathSnapshot>) -> u32 {
...
pub(in crate::runtime) fn default_transport_pto() -> Duration {

...
pub(in crate::runtime::path::tcp) struct ClientTcpDatagramAttachmentChannels {
    pub(in crate::runtime::path::tcp) attachment_id: u64,
    pub(in crate::runtime::path::tcp) frames_tx:
        mpsc::Sender<Result<ClientTcpDatagramInbound, RuntimeError>>,
    pub(in crate::runtime::path::tcp) frames_rx:
        mpsc::Receiver<Result<ClientTcpDatagramInbound, RuntimeError>>,
    pub(in crate::runtime::path::tcp) failure_tx: oneshot::Sender<()>,
    pub(in crate::runtime::path::tcp) failure_rx: oneshot::Receiver<()>,
}

pub(in crate::runtime::path::tcp) struct ClientTcpDatagramOpenCancellation {
...
impl ClientTcpDatagramAttachment {
    pub(in crate::runtime::path::tcp) fn channel(
        frame_queue: usize,
...
pub(in crate::runtime::path::tcp) struct ClientTcpDatagramState {
...
impl ClientTcpDatagramState {
    pub(in crate::runtime::path::tcp) fn new(flow_limit: usize, closed_flow_limit: usize) -> Self {
        Self {
    ...
    pub(in crate::runtime::path::tcp) fn attach(
        &mut self,
        attachment_id: u64,
        frames: mpsc::Sender<Result<ClientTcpDatagramInbound, RuntimeError>>,
    ...
    pub(in crate::runtime::path::tcp) fn validate_open_flow(
        &self,
        attachment_id: u64,
        flow_id: DatagramFlowId,
        target: &TargetAddr,
    ...
    pub(in crate::runtime::path::tcp) fn commit_open_flow(
        &mut self,
        attachment_id: u64,
        flow_id: DatagramFlowId,
        target: TargetAddr,
    ...
    pub(in crate::runtime::path::tcp) fn validate_outbound(
        &self,
        attachment_id: u64,
        frame: &Frame,
    ) -> Result<(), RuntimeError> {
    ...
    pub(in crate::runtime::path::tcp) fn route_inbound(
        &mut self,
        frame: Frame,
    ) -> Result<(), RuntimeError> {
    ...
    pub(in crate::runtime::path::tcp) fn attachment_flow_ids(
        &self,
        attachment_id: u64,
    ) -> Vec<DatagramFlowId> {
        self.flows
    ...
    pub(in crate::runtime::path::tcp) fn flow_ids(&self) -> Vec<DatagramFlowId> {
    ...
    pub(in crate::runtime::path::tcp) fn remove_attachment(&mut self, attachment_id: u64) {
    ...
    pub(in crate::runtime::path::tcp) fn clear(&mut self) {
        self.flows.clear();

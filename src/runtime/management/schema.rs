...
pub(super) struct ManagementSummary {
    ...
    pub(super) path_pacing_rate_bps: Option<String>,
}
...
pub(super) struct ManagementPathStatus {
    ...
    pub(super) usage_direction: Option<&'static str>,
    pub(super) srtt_ms: Option<f64>,
    pub(super) jitter_ms: Option<f64>,
    pub(super) latency_source: Option<&'static str>,
    pub(super) delivery_rate_bps: Option<String>,
    pub(super) delivery_rate_observed: Option<bool>,
    pub(super) delivery_rate_approximate: Option<bool>,
    pub(super) quality_approximate: Option<bool>,
    pub(super) delivery_rate_source: Option<&'static str>,
    pub(super) delivery_rate_scope: Option<&'static str>,
    pub(super) pacing_rate_bps: Option<String>,
    pub(super) pacing_rate_approximate: Option<bool>,
    pub(super) pacing_rate_source: Option<&'static str>,
    pub(super) loss_ppm: Option<u32>,
    pub(super) loss_approximate: Option<bool>,
    ...
    pub(super) ecn_source: Option<&'static str>,
    pub(super) queue_bytes: Option<String>,
    pub(super) bytes_in_flight: Option<String>,
    pub(super) data_level_bytes_in_flight: Option<String>,
    pub(super) inflight_limit_bytes: Option<String>,
    pub(super) confidence_ppm: Option<u32>,
    pub(super) app_limited: Option<bool>,
    pub(super) active_flows: u32,
    pub(super) active_latency_sensitive_flows: u32,
    pub(super) delivery_samples: Option<u32>,
    pub(super) data_sample_bytes: Option<String>,
    pub(super) last_delivery_age_ms: Option<u64>,
    pub(super) pacing_age_ms: Option<u64>,
    pub(super) freshness_horizon_ms: Option<u64>,
    pub(super) metric_age_scope: Option<&'static str>,
    pub(super) native_delivery_observed: Option<bool>,
    pub(super) product_delivery_observed: Option<bool>,
    pub(super) ack_derived_data_observed: Option<bool>,
}
...
pub(super) struct ManagementPeerPathStatus {
    ...
    pub(super) port_hopping: bool,
    pub(super) active_port: Option<u16>,
    pub(super) active_port_retired: bool,
    pub(super) path_id: String,
    pub(super) underlay: &'static str,
    pub(super) direction: &'static str,
    pub(super) metric_epoch: String,
    pub(super) metric_age_us: u32,
    pub(super) srtt_us: Option<u32>,
    pub(super) rttvar_us: Option<u32>,
    pub(super) jitter_us: Option<u32>,
    pub(super) latency_source: &'static str,
    pub(super) delivery_rate_bps: Option<String>,
    pub(super) delivery_rate_observed: bool,
    pub(super) delivery_rate_approximate: bool,
    pub(super) quality_approximate: bool,
    pub(super) delivery_rate_source: &'static str,
    pub(super) delivery_rate_scope: &'static str,
    pub(super) pacing_rate_bps: Option<String>,
    pub(super) pacing_rate_approximate: bool,
    pub(super) pacing_rate_source: Option<&'static str>,
    pub(super) loss_ppm: Option<u32>,
    pub(super) loss_approximate: bool,
    pub(super) ecn_ppm: Option<u32>,
    pub(super) loss_age_ms: Option<u64>,
    pub(super) ecn_age_ms: Option<u64>,
    ...
    pub(super) confidence_ppm: Option<u32>,
    pub(super) app_limited: Option<bool>,
    pub(super) ack_derived_data_observed: bool,
    pub(super) freshness_horizon_ms: Option<u64>,
    pub(super) metric_age_scope: &'static str,
    pub(super) data_sample_count: Option<u32>,
    pub(super) data_sample_bytes: Option<String>,
}

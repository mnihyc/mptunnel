...
pub const DEFAULT_TCP_FORWARD_MAX_CONNECTIONS: usize = 4_096;
pub const MAX_TCP_FORWARD_CONNECTIONS: usize = 1_048_576;
pub const DEFAULT_UDP_FORWARD_MAX_ASSOCIATIONS: usize = 4_096;
...
pub const DEFAULT_LOCAL_MAX_CONNECTIONS: usize = 4_096;
pub const DEFAULT_LOCAL_MAX_CONNECTIONS_PER_SOURCE: usize = 4_096;
pub const DEFAULT_LOCAL_MAX_CONNECTIONS_PER_PRINCIPAL: usize = 4_096;

...
pub(in crate::runtime) enum ResponseCarrierEmitMode {
    Classified,
    StreamOrdered,
}
...
pub(in crate::runtime) fn response_extra_traffic_startup_floor_bytes(
    mux_limits: MuxLimits,
) -> usize {
...
pub(in crate::runtime) fn response_repair_minimum_useful_attempt_bytes(
    mux_limits: MuxLimits,
) -> usize {

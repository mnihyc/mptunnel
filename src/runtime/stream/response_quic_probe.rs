//! Binding validation and carrier-queue admission for response QUIC probes.
//!
//! The session reservation and receipt-publication lifecycle is owned by
//! `response_quic_capacity` under the central tracker mutex.
...
// Product offsets and TCP ACK-clock calibration stay outside because they
// produce different proof.

use crate::performance::{
    ...
    DEFAULT_MAX_RETAINED_RECEIVE_RANGES, DEFAULT_PATH_FLIGHT_BYTES, DEFAULT_QUIC_PATH_IDLE_TIMEOUT,
...
impl From<ResourceLimits> for MuxLimits {
    fn from(value: ResourceLimits) -> Self {
        Self {
            ...
            max_quic_loss_journal_bytes: value.max_quic_loss_journal_bytes,

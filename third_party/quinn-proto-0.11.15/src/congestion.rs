...
pub struct PacketDeliveryState {
    ...
    /// Start of the current send interval.
    pub first_sent_time: Instant,
    /// Packet number within its QUIC packet-number space.
    pub packet_number: u64,
    /// Whether the sender lacked application data at send time.
    pub app_limited: bool,
    /// Bytes in flight immediately after this packet was sent.

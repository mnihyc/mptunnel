...
pub(super) fn apply_client_stream_data_state(
    ...
    #[cfg(feature = "lab-diagnostics")]
    {
        ...
        // Diagnostic cohort: the declared probe writes 64-byte echo requests;
        // retain smaller fragments without assuming a protocol stream ID.
        if (1..=64).contains(&payload_len)
            && crate::lab_diagnostics::lab_diagnostic_event_enabled("product_data_receipt")
        {
            lab_diagnostic(

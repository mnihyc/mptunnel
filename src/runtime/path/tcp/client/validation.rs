...
use super::super::group::ClientTcpCarrierReservation;
use super::super::retained::ClientTcpRetainedCarrierPublicationReservation;
use super::super::service::{
    ClientTcpCarrierAdmissionLease, ClientTcpServerToClientAdmissionLease,
};
use super::connection::{
    ClientTcpCarrierConnect, ClientTcpCarrierConnection, connect_client_tcp_carrier,
};
use super::receive::apply_client_tcp_carrier_demand;
use super::state::ClientTcpPathSessionRuntime;
...
pub(in crate::runtime) struct ClientTcpValidationAdmission {
    ...
    pub(in crate::runtime::path::tcp) service_admission: Option<ClientTcpCarrierAdmissionLease>,
    pub(in crate::runtime::path::tcp) server_to_client_admission:
        Option<ClientTcpServerToClientAdmissionLease>,
    pub(in crate::runtime::path::tcp) reservation: ClientTcpCarrierReservation,
    pub(in crate::runtime::path::tcp) endpoint_generation: u64,
    pub(in crate::runtime::path::tcp) validation_id: NonZeroU64,
    pub(in crate::runtime::path::tcp) request_id: Option<NonZeroU64>,
    pub(in crate::runtime::path::tcp) direction: PathMetricDirection,
    pub(in crate::runtime::path::tcp) stream_id: StreamId,
    pub(in crate::runtime::path::tcp) instance: RelayPathInstance,
...
impl ClientTcpElasticCarrierRuntime {
    pub(in crate::runtime::path::tcp) fn into_runtime(self) -> ClientTcpPathSessionRuntime {
        self.runtime
    }
}

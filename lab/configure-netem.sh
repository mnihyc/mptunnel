...
balanced_rate="${MPTUNNEL_LAB_BALANCED_RATE:-120mbit}"
...
matrix_good_rate="${MPTUNNEL_LAB_MATRIX_GOOD_RATE:-200mbit}"
matrix_poor_rate="${MPTUNNEL_LAB_MATRIX_POOR_RATE:-25mbit}"

...
impl ServerResponseSenderService {
    ...
    pub(in crate::runtime) fn next_prepared_recovery(
        ...
        // DIAGNOSTIC ONLY: ablate the complete new prepared query/service path.
        // Native commitment and existing actor recovery remain as in b00395a.
        const PREPARED_RECOVERY_QUERY_ENABLED: bool = false;
        if !PREPARED_RECOVERY_QUERY_ENABLED {
            return ResponsePreparedRecoveryObservation::default();
        }

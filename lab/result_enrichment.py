...
_SAFE_RUN_OVERRIDE = re.compile(
    ...
    r"MPTUNNEL_TCP_PATH_HEARTBEAT_(?:INTERVAL|TIMEOUT)_S|"
    r"MPTUNNEL_QUIC_PATH_(?:KEEP_ALIVE_INTERVAL|IDLE_TIMEOUT)_S|"
    r"PATH_PROBE_(?:INTERVAL|TIMEOUT)_S|"
    r"MPTUNNEL_LAB_OBJECT_MIB|"
    r"MPTUNNEL_LAB_(?:CLIENT|SERVER)_INITIAL_RATE_MBPS|"
    ...
    r"NETEM_MODE|INTERNET_(?:SEED|INCLUDE_OUTAGES|SCHEDULE_FILE|SCHEDULE_SHA256|GENERATOR_SHA256|LOAD_QUEUE_DELAY)|"

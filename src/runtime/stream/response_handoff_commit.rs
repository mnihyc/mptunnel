//! Clear-frontier response Service handoff commit.
//!
//! This owner revalidates binding/output/queue state and atomically commits the
//! frame plus persistent Service ownership. Drain serialization stays in
//! `response_handoff`.
...
use super::response_quic_capacity::quic_capacity_proof_pin_matches_marker;
use super::response_snapshot::server_bulk_output_snapshot_with_command_pending;
use super::response_topology::ResponseDispatchTarget;
#[cfg(test)]
